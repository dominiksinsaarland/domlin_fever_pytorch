...
class PreTrainedTokenizer(object):
    ...
    def encode_plus(self,
                    ...
                    return_tensors=None,
                    **kwargs):
        print ("tokenizer encode plus max length", max_length)
        input("")
        """
        ...
        if text_pair is not None and second_ids:
            first_ids, second_ids = _truncate_seq_pair(first_ids, second_ids, max_length - 3)
        print (first_ids, second_ids, max_length)
        if not second_ids:
            first_ids = first_ids[:max_length - 2]
    ...
    def prepare_for_model(self, ids, pair_ids=None, max_length=None, add_special_tokens=False, stride=0,
        ...
        if max_length:
            ...
            if pair and n_added_tokens + (len_pair_ids if truncate_first_sequence else len_ids) >= max_length:
                ...
                pair_ids = ids[:max_length - n_added_tokens]
